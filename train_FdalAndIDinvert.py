...
def main():
    ...
    parm='_ganloop_bs_%s_epoch%s_regcoef%s_%s_%s_adam%s_DIV_%s'%(args.train_batch_size,args.nepoch,loss_args.loss_pix_weight,loss_args.loss_w_weight,loss_args.loss_dst_weight,args.adam,args.divergence)
