...
def main():
    ...
    parm='_train_lr%s_bs_%s_epoch%s_regcoef%s_vgg%s_adam%s_DIV_%s'%(args.learn_rate,args.train_batch_size,args.nepoch,args.reg_coef,args.vgg,args.adam,args.divergence)
