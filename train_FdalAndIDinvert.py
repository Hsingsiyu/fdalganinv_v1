...
def main():
    ...
    parser.add_argument('--save_root', type=str, default='/home/xsy/idinvert_pytorch-mycode/output/')
    parser.add_argument('--divergence', type=str, default='kl')
    parser.add_argument('--reg_coef', type=int, default=100)
    ...
    parm='_train_bs_%s_epoch%s_regcoef%s_vgg%s'%(args.train_batch_size,args.nepoch,args.reg_coef,args.vgg)
    ...
    training_loop(args, datasets_args, E_lr_args, D_lr_args, opt_args, logger, writer,max_epoch=args.nepoch)
