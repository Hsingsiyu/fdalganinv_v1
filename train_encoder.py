...
def main():
    ...
    parser.add_argument('--gpu_ids', type=list, default=[0,1,2,3], #[0,1,2,3],
                        help='list of gpus')
    ...
    prefix = 'CelebAHQ-InitEncoder_StyleD'
    ...
    E_loss_args = EasyDict(loss_pix_weight=1.0, loss_feat_weight=0.00005, loss_adv_weight=0.1) # loss_adv=0.1 loss_feat_weight=0.00005
