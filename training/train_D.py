...
parser.add_argument("--data_root", type=str, default='', help="path") #todo
...
generator = StyleGANGeneratorNet(opt.image_size)
discriminator = StyleGANDiscriminator(opt.image_size,fmaps_max=128) #todo
generator.load_state_dict(torch.load('./models/pretrain/styleganinv_ffhq256_generator.pth'))
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        z = Variable(Tensor((0, 1, encode_dim)).normal_(0,1))

        # Generate a batch of images
        gen_imgs = generator.synthesis(z)
